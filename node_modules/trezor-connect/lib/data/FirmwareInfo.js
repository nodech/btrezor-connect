...
const checkFirmware = (fw, features) => {
  ...
  const modelFirmware = releases.filter(r => r.version[0] === fw[0]); // find latest firmware for this model
