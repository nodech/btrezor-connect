...
const createTx = (address_n, branch, operation) => {
  ...
  if (operation.reveal) {
    const reveal = operation.reveal; // validate reveal parameters
  ...
  if (operation.transaction) {
    const transaction = operation.transaction; // validate transaction parameters
  ...
  if (operation.origination) {
    const origination = operation.origination; // validate origination parameters
  ...
  if (operation.delegation) {
    const delegation = operation.delegation; // validate delegation parameters
